...
var iconPlay = '<i class="bs-icon-iconbofangda"></i>';
var iconPause = '<i class="bs-icon-iconzantingda"></i>';
var iconVolumeMute = '<i class="bs-icon-iconjingyin1"></i>';
var iconVolumeMedium = '<i class="bs-icon-iconyinliangda"></i>';
var iconVolumeLow = '<i class="bs-icon-iconyinliangxiao"></i>';
var iconExpand = '<i class="bs-icon-iconquanping"></i>';
var iconCompress = '<i class="bs-icon-icontuichuquanping"></i>';
...
players.forEach(function (player) {
    ...
    fullScreenButton.addEventListener('click', function (ee) {
...
function buildControls(skin) {
    ...
    html.push('<div class="progress">', '<div class="progress__filled"></div>', '</div>','<div class="video-btn">','<div class="left-btn">','<button class="' + skin + '__button toggle" title="Toggle Video">' + iconPlay + '</button>','</div>','<div class="right-btn">', '<button class="' + skin + '__button volume" title="Volume">' + iconVolumeMedium + '</button>', '<button class="' + skin + '__button fullscreen" title="Full Screen">' + iconExpand + '</button>','</div>','</div>');
...
function toggleFullScreen(player, fullScreenButton) {
    ...
    !document.mozFullScreenElement && !document.webkitFullscreenElement && !document.msFullscreenElement && !$(player).hasClass('ckin__fullscreen')) {
